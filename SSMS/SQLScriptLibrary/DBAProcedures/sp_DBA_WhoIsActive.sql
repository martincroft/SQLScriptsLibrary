-- sp_DBA_WhoIsActive.sql  #SQL
USE [master]
GO

/****** Object:  StoredProcedure [dbo].[sp_DBA_WhoIsActive]    Script Date: 11/16/2010 15:51:47 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[sp_DBA_WhoIsActive]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[sp_DBA_WhoIsActive]
GO
...
License:   
 ...
 written consent.  
*********************************************************************************************/  
CREATE PROC dbo.[sp_DBA_WhoIsActive]  
(  
--~  
...
EXEC sys.sp_addextendedproperty @name=N'Version', @value=N'10.0' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'PROCEDURE',@level1name=N'sp_DBA_WhoIsActive'
GO

GO
EXEC sys.sp_addextendedproperty @name=N'Description', @value=N'Get Active session information' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'PROCEDURE',@level1name=N'sp_DBA_WhoIsActive'
GO

EXEC sys.sp_addextendedproperty @name=N'Parameters', @value=N'@help=1' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'PROCEDURE',@level1name=N'sp_DBA_WhoIsActive'
GO   



IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[sp_Who3]') AND type in (N'P', N'PC'))
...
EXEC sp_MS_marksystemobject sp_who3

GO

GRANT EXEC ON sp_who3 TO PUBLIC 

GRANT EXEC ON sp_DBA_WhoIsActive TO PUBLIC 
